...
#' @param tcr_file `data.frame` of the T cell library generated by Cell Ranger. It is very important that the row with cell barcodes is strictly named `"barcode"`, which is the deafult name of barcodes in 10X's `all_contig_annotations.csv` file.
