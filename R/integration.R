...
#' concatenated into strings, separated by `join_by` in the metadata element
#' (defaults to `__`). Barcodes from the TCR library that had no matches to
#' barcodes in the `seurat_obj` will add `NA`s for all elements of the same
#' index.
#'
...
#' @param join_by character indicating the string to join duplicated information
#' in the same meta data cell by. defaults to `__`.
