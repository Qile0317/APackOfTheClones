...
#' @param clone_scale_factor numeric. Decides how much to scale each circle. Usually should be kept at around 0.01 to somewhat maintain UMAP structure for large datasets.
...
clonal_expansion_plot <- function(
  ...
  clone_size_list <- get_clone_sizes(integrated_seurat_obj, scale_factor = clone_scale_factor) #radii are square rooted!
