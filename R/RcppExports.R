...
rcppConstructLineLinkDf <- function(clusterLists, rawCloneSizes, sharedClones) {
    .Call(`_APackOfTheClones_rcppConstructLineLinkDf`, clusterLists, rawCloneSizes, sharedClones)
}
