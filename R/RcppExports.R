...
cpp_circle_layout <- function(input_rad_vec, centroid, rad_scale_factor = 1, ORDER = TRUE, try_place = FALSE, verbose = TRUE) {
    .Call(`_APackOfTheClones_cpp_circle_layout`, input_rad_vec, centroid, rad_scale_factor, ORDER, try_place, verbose)
}
