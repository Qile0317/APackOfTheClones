# APackOfTheClones (development version 1.0.0)
## Additions
* TODO

## Changes
* ALL v0.1.x functions are deprecated
* The latest version 2 of `scRepertoire` is now a dependency, and the package is now more structured like an extension of `scRepertoire` which in turn could be interpreted as a semi-extension of `Seurat`
