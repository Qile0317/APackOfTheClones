...
The main clonal expansion visualization that APackOfTheClones implements is shown in the following \autoref{fig:example}, using scRNA-seq + scTCR-seq data from @borcherding2021mapping.
