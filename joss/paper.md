...
An example of the main CE visualization that APackOfTheClones can produce is shown in the following \autoref{fig:example}, using scRNA-seq + scTCR-seq data from @borcherding2021mapping. The steps needed to generate the plot can be found in the [supplemental repository](https://github.com/Qile0317/APackOfTheClonesSupplemental)
