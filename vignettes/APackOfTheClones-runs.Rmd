...
And putting in identical arguments to generate the otiginal `ApotcData` would work too, but this approach is less recommended as its a lot more (unessecarily) verbose. Here is `APOTCPlot` in action:
