...
// tests - currently only for CirclePacker, everything else tested in R
// #include <Rcpp.h>
...
context("Rcpp | cpp_circle_layout helpers") {
    ...
    //     Rcpp::List trial = nodes.process_into_clusterlist(centroid, 0.5);
    //     Rcpp::NumericVector trial_x = trial[0], trial_y = trial[1];
    //     Rcpp::NumericVector trial_rad = trial[2], trial_centroid = trial[3];
    //     double trial_clRad = trial[4];
